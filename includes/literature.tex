...
Embora a amplitude desta área de estudo, alguns detalhes necessitavam ser observados para evitar, assim, redundância e perda de foco. A pesquisa deveria ser focada em técnicas e ferramentas para extração de metadados em artigos científicos, quer permitissem testes com dados reais, fazendo assim com que os resultados obtidos pudessem ser comparados e confrontados para verificar então a eficácia deste processo de extração.
...
Temos contato diariamente com diversos metadados, sejam eles visíveis naturalmente ou não, mas de uma maneira ou outra, são utilizados amplamente em tarefas do cotidiano; geralmente um conjunto enorme de novos dados e informações sobre recursos dos mais diversos tipos e modelos.

...
% ---
\titulo{Análise Comparativa de Ferramentas de Extração Automatizada de Metadados em Artigos Científicos}
\autor{José Alberto Grossi Júnior}
\local{Belo Horizonte/MG, Brasil}
\data{\thesisdate, v-\gitbranch, [\githash]}
...
\begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   Trabalho aprovado. \imprimirlocal, 27 de novembro de 2015:%\today:
...
\begin{dedicatoria}
   ...
   desejam superar seus próprios limites.} \vspace*{\fill}
\end{dedicatoria}
% ---
...
Agradecimentos especiais são direcionados aos meus pais por acreditarem sempre em minhas escolhas e principalmente pelo incentivo para que eu me torne sempre uma pessoa melhor a cada dia.
